...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('vendor/bisualmail/css/bisualmail-app.min.css') }}">
    <!-- Font Awesome -->
    ...
    <script src="{{ asset('vendor/bisualmail/js/bisualmail-app.js') }}"></script>
...
@section('content')
    ...
    <div class="row m-3">
        ...
        @if ( request()->route()->getName() !== 'backetfy.mails.newTemplate' && 
              request()->route()->getName() !== 'backetfy.mails.editMailable' &&
              request()->route()->getName() !== 'backetfy.mails.viewTemplate'
            )

            @include('bisualmail::layout.sidebar')
