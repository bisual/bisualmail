...
<div class="col-lg-10 col-md-12">
                ...
                <div class="card my-4">
                    <div class="card-header d-flex align-items-center justify-content-between"><h5>Plantillas</h5>
                        @if (!$templates->isEmpty() and auth()->user()->hasRole('super-admin'))
                        <a href="{{ route('backetfy.mails.selectNewTemplate') }}" class="btn btn-primary">Añadir plantilla</a>
                        @endif
                    </div>
                    ...
                    @component('bisualmail::layout.emptydata')
                        ...
                        <span class="mt-4">Ahora mismo no hay plantillas creadas</span>
                        @if (auth()->user()->hasRole('super-admin'))
                        <a class="btn btn-primary mt-3" href="{{ route('backetfy.mails.selectNewTemplate') }}">Añadir plantilla</a>
                        @endif
